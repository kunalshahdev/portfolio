...
function initScrollReveal() {
  ...
  document
    .querySelectorAll(
      'section, .service-card, .project-card, .stat-card, .skill-card, .contact-item',
    )
    .forEach((el) => {
      el.style.opacity = '0'
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        form.innerHTML =
          '<div class="form-success"><div class="form-success-icon">&#10003;</div><p>Thanks! I will get back to you soon.</p></div>'
      } catch {
        ...
        err.innerHTML =
          'Something went wrong. Email me at <a href="mailto:kunalshah1172@gmail.com">kunalshah1172@gmail.com</a>'
